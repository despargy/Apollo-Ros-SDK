...
///////////////////// END OF CONNECTION ESTABLISHED ////////////////////////////////
  ...
  apolloRobot.batteryNode();

  ros::Rate rate(2); //apolloRobot.scan_pub_period
  while(ros::ok())
  {
    // std::cout<<"Status "<<apolloRobot.velocityAction.getStatus()<<std::endl;
    // std::cout<<"Reason "<<apolloRobot.velocityAction.getReason()<<std::endl;

    apolloRobot.getLaserScanData();
    apolloRobot.getOdomData();
    apolloRobot.getBattery();
    // apolloRobot.getImuData();
